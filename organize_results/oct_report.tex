...
importance for the eight most influential taxa.  (I have chosen six,
...
\begin{table}
  \centering
\caption{\label{tbl:family_all_data_model_stats}Final model statistics using family-level taxa, all time steps}
\begin{tabular}{llrr}
