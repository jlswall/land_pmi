## This function was written by Pedro Martinez Arbizu and posted at
...
##
## sim.function = which function to calculate the similarity
## matrix. eg 'daisy' or 'vegdist' default is 'vegdist'
