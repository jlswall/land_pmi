...
%% {Presentation Title}
\title[]{Initial findings, mid-August}
...
\begin{frame}{Initial looks into phylum and family taxa}
  ...
  \noindent Data was read from Excel file \texttt{Shane\_all\_skin\_samples\_taxo\_bs\_05\_05\_2017.xlsx}
  \begin{itemize}
    \item Phylum data from \texttt{Phylum\_all} worksheet
    \item Family data from \textt{family\_all\_bsedit} worksheet
...
\item For both the phylum and family worksheets, 
\end{itemize}
