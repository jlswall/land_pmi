...
varImpPlot(rf, main="Importance of eukaryotic family-level taxa (first two weeks)")
dev.off()
...
ggsave("infl_euk_family_first_two_weeks_scatter.pdf", width=8, height=4, units="in")
## ##################################################
