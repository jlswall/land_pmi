...
## check that, for all of these taxa during just the first couple of
## weeks, each exceeds the frequency cutoff for at least two separate
## subject (can be same or different days).  Otherwise, those taxa
## should be considered "rare" for this analysis.
freqCutoff <- 0.01
...
write.csv(commontaxaT, file="families_hit_cutoff_twice_first_two_weeks.csv", row.names=FALSE)
## ##################################################
