...
## consider at each split is 18 (followed by 17 or 19) for response
...
## RMSE: 64.0752880 +/- 0.9388677
c(mean(fullRsq), 1.96*sd(fullRsq))
## Rsq: 0.816405452 +/- 0.005381492
...
## varImpPlot(rf, main="Importance of eukaryotic order-level taxa (first 15 days)")
## dev.off()
...
ggsave("infl_euk_order_first_two_weeks_scatter.pdf", width=8, height=4, units="in")
## ##################################################
