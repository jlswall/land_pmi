...
## variables to consider at each split should be around 17 (with 18
## and 19 very close), modeling the response variable in sqrt units.
numVarSplit <- 17
## ##################################################
...
varImpPlot(rf, main="Importance of eukaryote order taxa (sqrt. units, all time steps)")
dev.off()
