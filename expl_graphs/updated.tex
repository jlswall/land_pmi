...
\begin{frame}{Initial looks into phylum and family taxa}
  ...
  \item Order data from \texttt{Order\_all\_bsedit} worksheet
  ...
  \item There were 34 classified phylum taxa, 143 order taxa, and 230
    family taxa.
...
\noindent For order and family taxa, the above 3 methods give
different common (not rare) taxa.
