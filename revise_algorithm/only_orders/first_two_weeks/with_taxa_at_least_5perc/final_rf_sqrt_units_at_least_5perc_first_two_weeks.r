...
## Simulation runs indicated that the number of splits is around 7
...
write_csv(data.frame(sqrtcvMSE, sqrtcvErrFrac, origUnitsqrtcvMSE, origUnitsqrtcvErrFrac), path="final_rf_sqrt_units_cvstats_at_least_5perc_first_two_weeks.csv")
...
init.fig.dimen(file=paste0("sqrt_units_at_least_5perc_first_two_weeks_orders_imp_plot.pdf"), width=8, height=6)
