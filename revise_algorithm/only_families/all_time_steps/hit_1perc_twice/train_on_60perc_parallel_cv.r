...
numBtSampsVec <- c(600, 1200, 1800, 2400, 3000)
...
numLeaveOut <- round(0.40 * nrow(wideT))
...
for (j in 1:nrow(combos)){
  origFitL[[j]] <- mclapply(crossvalidL, mc.cores=5, origUnitsF, jCombo=j)
  if (j %% 2 == 0)
...
write_csv(combos, path="train_on_60perc_parallel_cv.csv")
