...
## Check that all of these taxa have at least one day and one cadaver
## during the first couple of weeks for which the frequency exceeds
## the cutoff for at least one individual.  Otherwise, those taxa
## should be considered "rare" for an analysis of just the first 2
## weeks.
freqCutoff <- 0.01
...
write.csv(commontaxaT, file="families_only_first_two_weeks.csv", row.names=FALSE)
## ##################################################
