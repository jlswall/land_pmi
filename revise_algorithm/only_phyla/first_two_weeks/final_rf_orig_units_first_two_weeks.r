...
## each split is about 10 for response variables in the original
## units, which is actually all of the available predictors.
numVarSplit <- 10
## ##################################################
...
init.fig.dimen(file=paste0("orig_units_first_two_weeks_phyla_imp_plot.pdf"), width=8, height=6)
varImpPlot(rf, main="Importance of phylum taxa (orig. units, first 2 weeks)")
dev.off()
## ##################################################
