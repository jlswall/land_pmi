...
init.fig.dimen(file=paste0("sqrt_units_first_two_weeks_phyla_imp_plot.pdf"), width=8, height=6)
varImpPlot(rf, main="Importance of phylum taxa (sqrt units, first 2 weeks)")
dev.off()
